-- @description Select all events in CC lane before and under mouse cursor (exclusive)
-- @version 1.0
-- @changelog
--   initial release
...
reaper.Undo_OnStateChange2(proj, "Select all events in CC"..cc_lane.." lane before and under mouse cursor (exclusive)")