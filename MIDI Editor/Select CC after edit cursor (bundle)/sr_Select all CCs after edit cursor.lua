...
local function SelectAllCCsAfterEditCursor(take, item, cursor_position_ppq)
...
if window == "midi_editor" then -- MIDI editor focused
	...
	SelectAllCCsAfterEditCursor(take, item, cursor_position_ppq) -- select all CCs after cursor
