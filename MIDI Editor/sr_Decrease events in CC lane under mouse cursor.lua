-- @description Decrease events in CC lane under mouse cursor
-- @version 1.0
-- @changelog
--   initial release
...
-- @about
--    # Description
--    * This script decreases all or selected CC events in the lane under the mouse cursor
...
function DecreaseCC(take, cc_lane, selected_events, decrease)
...
if reaper.TakeIsMIDI(take) then -- make sure, that take is MIDI
	...
	DecreaseCC(take, cc_lane, selected_events, decrease) -- decrease CC events
end

reaper.UpdateArrange()
reaper.Undo_OnStateChange2(proj, "Decrease events in CC"..cc_lane.." lane under mouse cursor")