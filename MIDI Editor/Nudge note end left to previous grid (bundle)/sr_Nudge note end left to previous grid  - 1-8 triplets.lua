...
require 'sr_Nudge note end left to previous grid function'
...
NudgeNoteEndLeft() -- call function
reaper.GetSetProjectGrid(proj, true, save_project_grid, save_swing, save_swing_amt) -- restore saved grid settings
reaper.Undo_OnStateChange2(proj, "Nudge note end left to previous grid - 1/8 triplets")