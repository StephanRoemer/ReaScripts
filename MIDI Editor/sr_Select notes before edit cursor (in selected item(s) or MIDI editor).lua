...
-- @about
--    # Description
--    * This script selects all notes before the edit cursor in currently selected items or in the currently opened take in the MIDI editor.
...
reaper.Undo_OnStateChange2(proj, "Select notes before edit cursor (in selected item(s) or MIDI editor)")