-- @description Human quantize notes 50% - 1/4 swing 70%
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script human quantizes either all notes or selected notes by 50% to the 1/4 grid swing 70%
...
reaper.Undo_OnStateChange2(proj, "Human Quantize 50% - 1/4 swing 70%")