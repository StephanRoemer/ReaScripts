-- @description Human quantize notes 50% - 1/4 triplets
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script human quantizes either all notes or selected notes by 50% to the 1/4 triplets grid
...
reaper.Undo_OnStateChange2(proj, "Human Quantize 50% - 1/4 triplets")