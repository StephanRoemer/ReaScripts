...
function SelectCCBeforeEditCursor(dest_cc)
	...
	local function SelectDestCCBeforeEditCursor(take, item, cursor_position_ppq)
	...
	if window == "midi_editor" then -- MIDI editor focused
		...
		SelectDestCCBeforeEditCursor(take, item, cursor_position_ppq) -- select CC before cursor
