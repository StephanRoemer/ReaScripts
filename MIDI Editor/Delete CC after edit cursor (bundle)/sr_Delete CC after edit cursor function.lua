...
function DeleteCCAfterEditCursor(dest_cc)
	...
	local function DeleteDestCCAfterEditCursor(take, item, cursor_position_ppq)
	...
	if window == "midi_editor" then -- MIDI editor focused
		...
		DeleteDestCCAfterEditCursor(take, item, cursor_position_ppq) -- delete CC after cursor
