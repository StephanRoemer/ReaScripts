...
require 'sr_Nudge note start right to next grid function'

local grid = 1/12 -- 1/8 triplets grid
...
NudgeNoteStartRight(grid) -- call function
reaper.GetSetProjectGrid(proj, true, save_project_grid, save_swing, save_swing_amt) -- restore saved grid settings
reaper.Undo_OnStateChange2(proj, "Nudge note start right to next grid - 1/8 triplets")