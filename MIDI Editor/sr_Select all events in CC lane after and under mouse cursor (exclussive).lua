-- @description Select all events in CC lane after and under mouse cursor (exclussive)
-- @version 1.0
-- @changelog
--   initial release
...
reaper.Undo_OnStateChange2(proj, "Select all events in CC"..cc_lane.." lane after and under mouse cursor (exclussive)")