...
local function NudgeNoteStartLeftArrange(take)
    ...
    for n = 0, notes_count - 1 do -- loop through all notes
        ...
        reaper.MIDI_SetNote(take, n, nil, nil, prev_grid_ppq, _, nil, nil, nil, true) -- nudge note start to the next grid
...
reaper.Undo_OnStateChange2(proj, "Nudge note start left to previous grid - grid")