...
-- @metapackage
-- @provides
--  [main=main,midi_editor,midi_inlineeditor] Decrease CC (bundle)/sr_Decrease CC1.lua
--  [main=main,midi_editor,midi_inlineeditor] Decrease CC (bundle)/sr_Decrease CC2.lua
--  [main=main,midi_editor,midi_inlineeditor] Decrease CC (bundle)/sr_Decrease CC7.lua
--  [main=main,midi_editor,midi_inlineeditor] Decrease CC (bundle)/sr_Decrease CC11.lua
--  [nomain] Decrease CC (bundle)/sr_Decrease CC (bundle).lua
--  [nomain] Decrease CC (bundle)/sr_Decrease CC function.lua
-- @about
--    # Description
