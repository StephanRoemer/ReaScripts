-- @description Quantize notes - 1/4 - swing 70%
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script quantizes either all notes or selected notes to 1/4 swing 70%
...
reaper.Undo_OnStateChange2(proj, "Quantize notes - 1/4 swing 70%")