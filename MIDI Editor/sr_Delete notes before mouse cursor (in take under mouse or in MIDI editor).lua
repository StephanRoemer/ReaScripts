-- @description Delete notes before mouse cursor (in take under mouse or in MIDI editor)
-- @version 1.0
-- @changelog
--  * initial release
...
-- @about
--    # Description
--    * This script deletes all notes before the mouse cursor in the take that the mouse is currently hovering (arrangement and inline editor) or in the focused MIDI editor
...
reaper.Undo_OnStateChange2(proj, "Delete notes before mouse (in take under mouse or in MIDI editor)")