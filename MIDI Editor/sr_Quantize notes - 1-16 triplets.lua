-- @description Quantize notes - 1/16 triplets
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script quantizes either all notes or selected notes to 1/8 triplets
...
reaper.Undo_OnStateChange2(proj, "Quantize notes - 1/16 triplets")