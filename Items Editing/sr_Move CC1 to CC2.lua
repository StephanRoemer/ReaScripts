        ...
        if reaper.TakeIsMIDI(take) then -- make sure, that take is MIDI
            ...
            for c = 0, ccCount - 1 do -- loop thru all CCs
                ...
                if cc == 1 then -- if CC is CC1
					reaper.MIDI_InsertCC(take, false, false, ppqposOut, chanmsgOut, chanOut, 2, ccValue) -- insert CC1 values into CC2 lane
					reaper.MIDI_DeleteCC(take, c) -- after copying CC1 to CC2, delete CC1 (=move)
                end
            end
        end
    end
