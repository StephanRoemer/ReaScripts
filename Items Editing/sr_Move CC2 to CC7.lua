...
-- @about
--    # Description
--    - this script moves CC2 data to CC7
        ...
        if reaper.TakeIsMIDI(take) then -- make sure, that take is MIDI
            ...
            for c = 0, ccCount - 1 do -- loop thru all CCs
                ...
                if cc == 2 then -- if CC is CC2
					reaper.MIDI_InsertCC(take, false, false, ppqposOut, chanmsgOut, chanOut, 7, ccValue) -- insert CC2 values into CC7 lane
					reaper.MIDI_DeleteCC(take, c) -- after copying CC2 to CC7, delete CC2 (=move)
                end
            end
        end
    end
