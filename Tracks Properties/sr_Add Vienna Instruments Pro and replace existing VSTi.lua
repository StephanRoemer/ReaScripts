-- @description Add Vienna Instruments Pro and replace existing VSTi
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script adds a Vienna Instruments Pro instance in FX slot 1
...
VSTi = "Vienna Instruments Pro (VSL) (8 out)" -- VSTi identifier
pluginName = "Vienna Instruments Pro" -- plugin name
