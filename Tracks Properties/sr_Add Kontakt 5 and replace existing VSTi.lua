-- @description Add Kontakt 5 and replace existing VSTi
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script adds a Kontakt 5 instance in FX slot 1
...
VSTi = "Kontakt 5 (Native Instruments GmbH) (64 out)" -- VSTi identifier
pluginName = "Kontakt 5" -- plugin name
