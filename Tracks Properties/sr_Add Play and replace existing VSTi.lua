-- @description Add Play and replace existing VSTi
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script adds a Play instance in FX slot 1
...
VSTi = "Play (East West) (18 out)" -- VSTi identifier
pluginName = "Play" -- plugin name
