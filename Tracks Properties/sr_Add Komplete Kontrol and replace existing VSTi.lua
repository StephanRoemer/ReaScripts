-- @description Add Komplete Kontrol and replace existing VSTi
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script adds a Komplete Kontrol instance in FX slot 1
...
VSTi = "Komplete Kontrol (Native Instruments GmbH) (32 out)" -- VSTi identifier
pluginName = "Komplete Kontrol" -- plugin name
