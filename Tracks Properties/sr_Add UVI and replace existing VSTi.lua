-- @description Add UVI and replace existing VSTi
-- @version 1.0
-- @author Stephan Römer
-- @about
--    # Description
--    - this script adds an UVI instance in FX slot 1
...
VSTi = "UVIWorkstation (UVI) (34 out)" -- VSTi identifier
pluginName = "UVI" -- plugin name
