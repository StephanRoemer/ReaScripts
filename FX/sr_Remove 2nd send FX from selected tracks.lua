--[[
@description Remove 2nd send FX from selected tracks
@version 1.0
@author Stephan Römer
@about
    # Description
    - this script removes the 2nd send FX in the send slot of selected track(s)
...
if reaper.CountSelectedTracks(0) == 0 then
    ...
    for i = 0, selected_tracks-1 do -- loop thru all selected tracks
        ...
        reaper.RemoveTrackSend(track, 0, 1) -- remove 2nd send of selected track(s)
    end
end

reaper.Undo_EndBlock("Remove 2nd send FX", 1)
